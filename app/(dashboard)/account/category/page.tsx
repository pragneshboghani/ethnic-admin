...
import ViewDetailsModal from '@/components/category/ViewDetailsModal';
    ...
    return (
        <>
            ...
            {showData.data !== null && (
                ...
                <ViewDetailsModal showData={showData} setShowdata={setShowdata} platformData={platformData} handleEdit={handleEdit} handleDeleteCategory={handleDeleteCategory} />
            )}
        </>
    )
}
